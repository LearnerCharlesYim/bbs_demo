...
Revision ID: be99e3848c39
Revises: 5a832e761700
Create Date: 2021-03-27 21:50:46.574097
...
revision = 'be99e3848c39'
down_revision = '5a832e761700'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('MALE', 'FEMAIL', 'SECRET', 'UNKNOW', name='genderenum'), nullable=True),
