...
class CommentModel(db.Model):
    ...
    father_comment = db.relationship("CommentModel",backref='replies',remote_side=[id])
...
class CommentStarModel(db.Model):
    ...
    author = db.relationship('FrontUser', backref='comment_stars')
    comment = db.relationship('CommentModel', backref='stars')
